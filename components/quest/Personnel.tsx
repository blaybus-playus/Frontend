...
import { quest_badge_insa } from '@/assets/images'
      ...
      <AccordionItem value="item-1">
        <AccordionTrigger onClick={() => setOpen(!open)}>
          <div className='flex items-center gap-3' >
            <Image
              ...
              height={40}
            />
            <h3 className='title-bold-20'>인사평가</h3>
          </div>
        </AccordionTrigger>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            {open ?
              <span className="body-regular-14">평가 우수</span>
              : <span className="title-semibold-16">20</span>
            }
          </div>
          <div className="flex items-center gap-3">
            ...
            {open ?
              <span className="body-regular-14">평가 양호</span>
              :
              <span className="title-semibold-16">23</span>
            }
          </div>
        </div>
        ...
        <AccordionContent>
          <div className='flex flex-wrap items-center gap-1 h-auto'>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>7주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>14주</div>
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>15주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>17주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>20주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>24주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>28주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>30주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>33주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>36주</div>
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>37주</div>
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>38주</div>
            ...
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>40주</div>
            <div className='flex justify-center items-center w-7 h-7 rounded-md text-white body-semibold-12 bg-[#FBD288] flex-shrink-0'>41주</div>
