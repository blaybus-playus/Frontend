  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="ml-auto body-medium-12 text-gray-600">(단위: do)</div>
        <div className="space-y-6">
          <div className="flex items-center">
            ...
            <div className="ml-auto body-medium-12 text-gray-400">0 ~ 13,500</div>
          </div>
          <div className="flex items-center">
            <Image
              src={level_badge_02}
            ...
            <div className="ml-auto body-medium-12 text-gray-400">27,000 ~ 51,000</div>
          </div>
          <div className="flex items-center">
            <Image
              src={level_badge_03}
            ...
            <div className="ml-auto body-medium-12 text-gray-400">63,000 ~ 93,000</div>
          </div>
          <div className="flex items-center">
            <Image
              src={level_badge_04}
            ...
            <div className="ml-auto body-medium-12 text-gray-400">108,000 ~ 144,000</div>
          </div>
          <div className="flex items-center">
            <Image
              src={level_badge_05}
